...
install(FILES "${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}.nro" DESTINATION "switch/${PROJECT_NAME}")

set(README_PATH "switch/${PROJECT_NAME}")
set(README_DRIVER "${CMAKE_CURRENT_LIST_DIR}/INSTALL.md")
set(LICENSE_PATH "switch/${PROJECT_NAME}/licenses")
