...
# Package
install(FILES ${CMAKE_CURRENT_LIST_DIR}/resources/SuperHaxagon.sh DESTINATION .)

# Game files
install(TARGETS ${CMAKE_PROJECT_NAME} RUNTIME DESTINATION ./superhaxagon)
install(DIRECTORY ${CMAKE_SOURCE_DIR}/romfs DESTINATION ./superhaxagon)

# Licenses
install(DIRECTORY ${CMAKE_CURRENT_LIST_DIR}/resources/licenses DESTINATION ./superhaxagon)
...
install(FILES
    ...
    ${CMAKE_CURRENT_LIST_DIR}/resources/README.md
