...
# Append flatpak information
if(DEFINED ENV{FLATPAK_ID})
    list(APPEND RUNNER_INFORMATION_LIST "Run: Flatpak Builder")
    list(APPEND RUNNER_INFORMATION_LIST "ID: $ENV{FLATPAK_ID}")
    string (REPLACE ";" "\n" RUNNER_INFORMATION "${RUNNER_INFORMATION_LIST}")
endif()

configure_file(${CMAKE_CURRENT_LIST_DIR}/VERSION.txt.in VERSION.txt)
